...
export default {
  ...
  methods: {
    gibOldUserInfo() {
      //vraca na stranicu user info unesen pri registraciji
    ...
    gibCurrentUserInfo() {
      //vraca na stranicu user info iz Firebasea i sprema u current polja
    ...
    resetUserInfo() {
      //resetira user info na onaj unesen prije promjena
      this.storeOldInfo();
      // alert(this.tempfullname);
      docRef
        .set(
    ...
    saveNewUserInfo() {
      //koristimo .set za updateat info, provjerava koja je polja user ispunio, poziva funkciju da spremi novi unesen info
