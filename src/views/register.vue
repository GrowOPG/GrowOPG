  ...
  <body class="d-flex flex-column min-vh-100">
    <div class="bg">
      <div class="signup">
        ...
        <div class="container">
          <div v-if="store.userType == 'Seller'" class="form-box-seller">
            <!--pocetak seller form boxa-->
            <div class="row">
              <div class="col-6">
                <form id="form">
                  <div class="sgp-form">
                  ...
                  <div v-if="store.userType == 'Seller'" class="sgp-form">
                    ...
                    <input
                      ...
                      id="opgname"
                      required
                      placeholder="Enter your OPG name"
                    />
                  </div>
                  ...
                  <div class="sgp-form">
                    ...
                    />
                    <div v-if="password != passwordrepeat" class="text-danger">
          ...
          <!-- kraj sellerform boxa-->
          <div v-if="store.userType == 'Buyer'" class="form-box">
            <!--pocetak buyer form boxa-->
            <div class="row">
              <div class="col-6">
                <form id="form">
                  <div class="sgp-form">
